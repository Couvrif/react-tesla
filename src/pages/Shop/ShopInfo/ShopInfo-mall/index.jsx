...
const ShopInfoMall = memo((props) => {
  ...
  return (
    <ShopInfoMallWrapper ref={mainRef}>
      ...
      <div className="mainTitle">Tesla 官方商店 | Tesla</div>
...
ShopInfoMall.propTypes = {}

export default ShopInfoMall
